...
public abstract class BaseBottomSheetDialogFragment<T extends ViewDataBinding, V extends BaseViewModel> extends BottomSheetDialogFragment implements BaseNavigator {
    ...
    public ViewDataBinding getActivityBinding(){
        ...
        return getBaseActivity().getViewDataBinding();
    }
